			...
			<div class="content">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <form method="post" class="card card-border mb-0 h-100" enctype="multipart/form-data" action="<?= base_url("suratmasuk/addproses") ?>">
								...
								<div class="card-body">
                                    <div class="row">
										<div class="col-md-6">
											...
											<div class="form-group">
												<label>Dari:</label>
												<input type="text" value="<?= $ddata[0]['dari'] ?>" name="dari" class="form-control" placeholder="Dari" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
                                ...
                                <div class="card-footer">
                                    <a href="<?= base_url("suratmasuk") ?>" class="btn btn-secondary">Batal</a>
