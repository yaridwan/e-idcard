...
$sdata = $this->db->query("SELECT a.*, b.`nm_jenissurat` FROM suratmasuk a LEFT JOIN jenissurat b ON a.`id_jenissurat` = b.`id_jenissurat` WHERE a.nosmasuk = '".$nosmasuk."'");
		...
		<div class="page-header-content container header-elements-md-inline">
			...
			<div class="header-elements d-none bg-transparent border-0 py-0 mb-3 mb-md-0">
				<div class="breadcrumb">
					...
					<a href="<?= base_url("suratmasuk") ?>" class="breadcrumb-item">Surat Masuk</a>
                        ...
                        <div class="card card-border mb-0 h-100">
							...
							<table class="table table-hover mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Berkas Surat</td>
                                        <th><a href="<?= base_url("berkas/smasuk/".$ddata[0]['berkas']) ?>" class="form-control font-weight-bold" target="_blank"><?= $ddata[0]['berkas'] ?></a></th>
                                    </tr>
                                </tbody>
                            </table>
						</div>
                                    ...
                                    <table class="table table-hover mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-dark text-center"><a href="#" data-toggle="modal" data-target="#modalDisposisi" class="btn btn-primary">Disposisikan Surat</a></th>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php
                                                $nodispo = 1;
                                                $sdispo = $this->db->query("SELECT a.*, b.`nm_sifat`, c.nm_pegawai AS nm_sumber, d.nm_pegawai AS nm_tujuan FROM disposisi a LEFT JOIN sifat b ON a.`id_sifat` = b.`id_sifat` LEFT JOIN pegawai c ON a.sumber = c.no_pegawai LEFT JOIN pegawai d ON a.tujuan = d.no_pegawai WHERE a.nosmasuk = '".$nosmasuk."'");
                    ...
                    <form method="post" class="modal-content">
                        ...
                        <div class="modal-footer">
                            <!-- <div class="alert alert-warning mt-0 mb-3">
                                Sebelum melanjutkan, pastikan data yang sudah Anda tambahkan sudah benar. Data yang sudah didisposisikan tidak bisa dihapus kembali.
                            </div> -->
