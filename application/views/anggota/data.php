                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                    $nodata = 1;
                                    $sdata = $this->db->query("SELECT a.*, b.`nm_jenissurat`,  c.`nm_jk` FROM suratmasuk a LEFT JOIN jenissurat b ON a.`id_jenissurat` = b.`id_jenissurat` LEFT JOIN jk c ON a.`id_jk` = c.`id_jk` ORDER BY a.nosmasuk DESC");
