...
if(isset($post['simpan'])){
    ...
    $simpan = $this->db->insert("jabatan", $post_data);
    if($simpan){
    ...
    $simpan = $this->db->update("jabatan", $post_data, array("id_jabatan" => $post['id_jabatan']));
    if($simpan){
    ...
    $simpan = $this->db->delete("jabatan", array("id_jabatan" => $post['id_jabatan']));
    if($simpan){
...
<body>
                                        ...
                                        echo"
                                            <tr>
                                                ...
                                                <td class='text-center'>
                                                    <div class='btn-group'>
                                                        <a href='#' class='btn btn-primary btedit' data-toggle='modal' data-target='#modalEdit' data-id='".$ddata['id_jabatan']."' data-nama='".$ddata['nm_jabatan']."'><i class='icon-pencil7'></i></a>
                                                        <a href='#' class='btn btn-danger bthapus' data-toggle='modal' data-target='#modalHapus' data-id='".$ddata['id_jabatan']."' data-nama='".$ddata['nm_jabatan']."'><i class='icon-trash'></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        ";
            ...
            <form method="post" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nm_jabatan" class="form-control" placeholder="Nama jabatan" required>
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="post" class="modal-content">
                <input type="hidden" name="id_jabatan" id="id_jabatan_edit">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Jabatan :</label>
                        <input type="text" name="nm_jabatan" id="nm_jabatan_edit" class="form-control" placeholder="Nama jabatan" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <form method="post" class="modal-content">
                <input type="hidden" name="id_jabatan" id="id_jabatan_hapus">
                <div class="modal-header">
