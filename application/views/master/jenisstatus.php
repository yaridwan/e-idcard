...
if(isset($post['simpan'])){
    $post_data = array(
        "nm_jenissurat" => $post['nm_jenissurat']
    );
    $simpan = $this->db->insert("jenissurat", $post_data);
    if($simpan){
    ...
    redirect(base_url("master/jenissurat"));
}else if(isset($post['edit'])){
    $post_data = array(
        "nm_jenissurat" => $post['nm_jenissurat']
    );
    $simpan = $this->db->update("jenissurat", $post_data, array("id_jenissurat" => $post['id_jenissurat']));
    if($simpan){
    ...
    $simpan = $this->db->delete("jenissurat", array("id_jenissurat" => $post['id_jenissurat']));
    if($simpan){
...
<body>
                                        ...
                                        echo"
                                            <tr>
                                                ...
                                                <td class='text-center'>
                                                    <div class='btn-group'>
                                                        <a href='#' class='btn btn-primary btedit' data-toggle='modal' data-target='#modalEdit' data-id='".$ddata['id_jenissurat']."' data-nama='".$ddata['nm_jenissurat']."'><i class='icon-pencil7'></i></a>
                                                        <a href='#' class='btn btn-danger bthapus' data-toggle='modal' data-target='#modalHapus' data-id='".$ddata['id_jenissurat']."' data-nama='".$ddata['nm_jenissurat']."'><i class='icon-trash'></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        ";
            ...
            <form method="post" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama jenis Status :</label>
                        <input type="text" name="nm_jenissurat" class="form-control" placeholder="Nama jenissurat" required>
                    </div>
                </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form method="post" class="modal-content">
                <input type="hidden" name="id_jenissurat" id="id_jenissurat_edit">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nm_jenissurat" id="nm_jenissurat_edit" class="form-control" placeholder="Jenis Status" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <form method="post" class="modal-content">
                <input type="hidden" name="id_jenissurat" id="id_jenissurat_hapus">
                <div class="modal-header">
    ...
    ?>
		...
		$(document).ready(function() {
            ...
            $(document).on('click', '.btedit', function() {
				const id 	= $(this).data('id');
				const nama 	= $(this).data('nama');
				$('#id_jenissurat_edit').val(id);
				$('#nm_jenissurat_edit').val(nama);
			});
