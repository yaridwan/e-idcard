...
<head>
    ...
    <title>Error 404 - <?= identitas("judul") ?></title>
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4">
                                    <div class="col-12 text-center mb-4">
                                        ...
                                        <h5>OOP! HALAMAN TIDAK DITEMUKAN</h5>
                                        <span class="">Maaf, halaman yang Anda cari tidak ditemukan. Kami akan segera menyelesaikan permasalahan ini.</span>
                                    </div>
