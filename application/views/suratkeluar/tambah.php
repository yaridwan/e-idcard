                                ...
                                <div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="noskeluar" class="form-control font-weight-bold" value="<?= autoskeluar() ?>" readonly>
												</div>
												<div class="form-group">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label>Berkas Surat (PDF):</label>
													<div class="form-group">
														<input type="file" name="berkas" class="form-control" id="inputGroupFile04" accept="application/pdf" required>
													</div>
												</div>
											</div>
										</div>
