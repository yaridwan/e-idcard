...
$sdata = $this->db->query("SELECT a.*, b.`nm_jenissurat` FROM suratkeluar a LEFT JOIN jenissurat b ON a.`id_jenissurat` = b.`id_jenissurat` WHERE LEFT(a.tanggal, 4) = '".$tahun."' ORDER BY a.noskeluar DESC");
        $judulnya = "LAPORAN SURAT KELUAR TAHUN ".$tahun;
?>
